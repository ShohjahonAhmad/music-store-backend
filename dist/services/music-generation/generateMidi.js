...
import { renderToMidiBuffer } from "./render.js";
/**
 ...
 */
export function generateMidi(seed) {
    const rng = seedrandom(seed);
    const composition = composeSong(rng);
    return renderToMidiBuffer(composition, rng);
}
//# sourceMappingURL=generateMidi.js.map